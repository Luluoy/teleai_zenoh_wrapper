...
class ZenohPub():
    def __init__(self, conf: str | None = None, key: str | None = None) -> None:
    ...
    def pub(self, payload: TimestampedBufPacket):
...
class ZenohSub():
    ...
    def _listen(self, sample: zenoh.Sample) -> None:
        with self._lock:
            ...
            self.last_recv_ns = pkt.timestamp_ns
            self._info = pkt
